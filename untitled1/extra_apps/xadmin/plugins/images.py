...
def get_gallery_modal():
    return """
        <!-- modal-gallery is the modal dialog used for the img gallery -->
        <div id="modal-gallery" class="modal modal-gallery fade" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body"><div class="modal-img"><h1 class="loader"><i class="fa-spinner fa-spin fa fa-large loader"></i></h1></div></div>
...
class ModelDetailPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        if self.include_image:
            media = media + self.vendor('img-gallery.js',
                                        'img-gallery.css')
        return media
...
class ModelListPlugin(BaseAdminPlugin):
    ...
    # Media
    def get_media(self, media):
        return media + self.vendor('img-gallery.js', 'img-gallery.css')
