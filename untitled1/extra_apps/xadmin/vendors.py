...
vendors = {
    ...
    "img-gallery": {
        "css": {
            'dev': 'xadmin/vendor/bootstrap-img-gallery/css/bootstrap-img-gallery.css',
            'production': 'xadmin/vendor/bootstrap-img-gallery/css/bootstrap-img-gallery.css',
        },
        "js": {
            'dev': ['xadmin/vendor/load-img/load-img.js', 'xadmin/vendor/bootstrap-img-gallery/js/bootstrap-img-gallery.js'],
            'production': ['xadmin/vendor/load-img/load-img.min.js', 'xadmin/vendor/bootstrap-img-gallery/js/bootstrap-img-gallery.js']
        }
    },
    "select": {
        "css": {
