...
(function (factory) {
    ...
    $.extend($.fn.modal.Constructor.DEFAULTS, {
        ...
        // filter out label and thumbnail linking twice to the same img):
        filter: '*',
        // The index of the first gallery img to show:
        index: 0,
        // The href of the first gallery img to show (overrides index):
        href: null,
        // The range of images around the current one to preload:
        preloadRange: 2,
        // Offset of img width to viewport width:
        offsetWidth: 100,
        // Offset of img height to viewport height:
        offsetHeight: 230,
        // Set to true to display images as canvas elements:
        canvas: false,
        // Shows the next img after the given time in ms (0 = disabled):
        slideshow: 0,
        // Defines the img division for previous/next clicks:
    ...
    $.extend($.fn.modal.Constructor.prototype, {
        ...
        loadImage: function () {
            ...
            // if the img has already been loaded:
            this._loadingTimeout = window.setTimeout(function () {
                modal.addClass('modal-loading');
            }, 100);
            oldImg = modal.find('.modal-img').children('img').removeClass('in');
        ...
        showImage: function (img) {
            var modal = this.$element,
                ...
                modalImage = modal.find('.modal-img'),
                clone,
                forceReflow;
            modalImage.css({
                width: img.width,
        ...
        initGalleryEvents: function () {
            var $this = this,
                modal = this.$element;
            modal.find('.modal-img').on('click.modal-gallery', function (e) {
                var modalImage = $(this);
        ...
        destroyGalleryEvents: function () {
            ...
            this.abortLoad();
            this.stopSlideShow();
            modal.find('.modal-img, .modal-prev, .modal-next, .modal-slideshow')
